 ...
 * the JWT attached automatically by [com.example.musicapp.data.network.AuthInterceptor].
 *
...
class AuthRepository @Inject constructor(
     ...
     * [com.example.musicapp.data.network.AuthInterceptor] synchronously when an
